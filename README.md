...
ข้อยกเว้น: เมื่อเลือกเมนู **ตรวจ Activity วันนี้และส่ง LINE** จาก Google Sheets
ระบบจะบังคับตรวจและส่งได้ทุกวัน รวมถึงวันเสาร์ วันอาทิตย์ และวันที่อยู่ในชีต `วันหยุด`
