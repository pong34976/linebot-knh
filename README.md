...
คำว่า `ว่าง`
ช่วงเวลา 12:00-13:00 ระบบจะเติม `พักกลางวัน` ในคอลัมน์ `งานที่ 1` และ
`รายละเอียด` ให้อัตโนมัติ
...
ทริกเกอร์อัตโนมัติจะไม่ส่ง LINE ในวันเสาร์ วันอาทิตย์ หรือวันที่อยู่ในชีต `วันหยุด`
แต่เมนู **ตรวจ Activity วันนี้และส่ง LINE** เป็นช่องทางเดียวที่บังคับตรวจและส่งได้
ทุกวัน โดยต้องกรอกรหัสยืนยัน `ok` ก่อนส่ง
บรรทัดสรุปดาวใช้รูปแบบ `จำนวนคนลงครบ/จำนวนคนทั้งหมด` เช่น `⭐ (1/11)`
